...
class AllClubActivitiesPage extends StatefulWidget {
  final int total;
  final int initialIndex;

  AllClubActivitiesPage({required this.total, this.initialIndex = 0});

  @override
  _AllClubActivitiesPageState createState() => _AllClubActivitiesPageState();
}

class _AllClubActivitiesPageState extends State<AllClubActivitiesPage>
