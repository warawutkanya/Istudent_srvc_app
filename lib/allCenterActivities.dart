...
class AllCenterActivitiesPage extends StatefulWidget {
  final int total;
  final int initialIndex;

  AllCenterActivitiesPage({required this.total, this.initialIndex = 0});

  @override
  _AllCenterActivitiesPageState createState() =>
      _AllCenterActivitiesPageState();
}

class _AllCenterActivitiesPageState extends State<AllCenterActivitiesPage>
